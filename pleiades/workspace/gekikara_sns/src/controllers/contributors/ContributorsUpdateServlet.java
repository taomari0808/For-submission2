...
/**
 * Servlet implementation class ContributorsUpdateServlet
 */
@WebServlet("/contributors/update")
public class ContributorsUpdateServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ContributorsUpdateServlet() {
        super();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            Contributor e = em.find(Contributor.class, (Integer)(request.getSession().getAttribute("contributor_id")));
            ...
            List<String> errors = ContributorValidator.validate(e, codeDuplicateCheckFlag, passwordCheckFlag);
            if(errors.size() > 0) {
                em.close();
                ...
                request.getSession().removeAttribute("contributor_id");
