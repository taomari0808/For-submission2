 ...
 */
@WebServlet("/reports/editdelete")
public class ReportsEditDeleteServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportsEditDeleteServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(r != null && login_contributor.getId() == r.getContributor().getId()) {
            ...
            request.setAttribute("_delete_flg", "1");
        }
